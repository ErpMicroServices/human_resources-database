        ...
        if (this._currentEnvironment == defaultEnvironment()) {
            this._config = {
                database: {
                    ...
                    database: process.env.DATABASE_DATABASE || 'human-resources-database',
                    user: process.env.DATABASE_USER || 'human-resources',
                    password: process.env.DATABASE_PASSWORD || 'human-resources'
                }
            };
        } else {
